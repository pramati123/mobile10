...
public class HrdbQueryExecutorServiceImpl implements HrdbQueryExecutorService {
    ...
    @Transactional(readOnly = true, value = "hrdbTransactionManager")
    @Override
    public Downloadable exportHrdbUserData(ExportType exportType, Pageable pageable) {
        Map params = new HashMap(0);


        return queryExecutor.exportNamedQueryData("HrdbUserData", params, exportType, HrdbUserDataResponse.class, pageable);
    }
